...
// Payload messages
const int LOCATION_COORDINATE_X = MESSAGE_TYPE  + 4;
...
// Peerinfo messages
const int PEERINFO_NUMENTRIES_POS = MESSAGE_TYPE  + 4;
const int PEERINFO_ENTRIES_START = PEERINFO_NUMENTRIES_POS  + 4;
const int PEERINFO_ENTRY_SIZE = 8 + 8 + ADDRESS_LENGTH_OCTETS;

const int PEERINFO_ENTRY_LOCATION_X = 0;
